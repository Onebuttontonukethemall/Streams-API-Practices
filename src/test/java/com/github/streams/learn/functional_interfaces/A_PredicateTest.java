...
class A_PredicateTest {
  ...
  public void a_predicate2() {
    Predicate<String> pred = (String s) -> {return s.isEmpty();};
  ...
  public void a_predicate4() {
    ...
    Predicate<String> startsWithJAndLengthIs7 = (String s) -> startsWithJ.and(lengthIs7).test(s);
  ...
  public void a_predicate5() {
    ...
    Predicate<String> lengthIs9orError = (String s) -> {
      return lengthIs9.test(s) || equalsError.test(s);
    };
